...
{ 
    ...
    if(insertUserSubmits($link,$id,$_REQUEST['date'],$_REQUEST['time'],$_REQUEST['sale'],$_REQUEST['done'],$_REQUEST['c_name'],$_REQUEST['c_contact'])>0){
    ...
    <div class="container-width">
        <div id="i14q" class="gjs-row">
            <div id="i91j" class="gjs-cell">
                ...
                <div >
                    <div class="box" >
                    <form action="day_end_customer_submit.php" enctype="multipart/form-data" method="post">
                            <div class="modal-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                    <input type="text" name="c_contact" style="font-size:0.8em" class="form-control" id="sale" placeholder="john.doe@email.com" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="text" name="name" style="font-size:0.8em" class="col-sm-6 col-form-label">
