                    ...
                    <form id="formAwesome" action="add_vehicle.php" enctype="multipart/form-data" method="post">
                                ...
                                <select class="form-control" name="model_id" id="awesomeness" style="font-size:0.8em">
                                    ...
                                    if(isset($model)){
                                        foreach ($model as $key => $value) {
                                            ?><option value="<?php echo $value->getId() ?>" <?php echo $car !== null && ($car->getModel_id())==($value->getId())? "selected":"" ;?>><?php echo $value->getName() ?></option><?php
                                        }
                                    }
                                    ?>
                                </select>
                            ...
                            <div class="form-group row">
                                ...
                                <select class="form-control" name="fuel" id="awesomeness" style="font-size:0.8em">
                                    <option value="Petrol" <?php echo $car !== null && $car->getFuel()=="Petrol"? "selected":"" ;?>>Petrol</option>
                                    <option value="Deasol" <?php echo $car !== null && $car->getFuel()=="Deasol"? "selected":"" ;?>>Deasol</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                <input type="text" name="name" value= "<?php echo $car !== null ? $car->getName():"" ;?>" style="font-size:0.8em" class="form-control" id="firstName" placeholder="John" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                <input type="text" name="grade" value= "<?php echo $car !== null ? $car->getGrade():"" ;?>"  style="font-size:0.8em" class="form-control" id="lastName" placeholder="Doe" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                <input type="text" name="power" value= "<?php echo $car !== null ? $car->getPower():"" ;?>"  style="font-size:0.8em" class="form-control" id="email" placeholder="john.doe@email.com" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                <input type="number" name="model_year" value= "<?php echo $car !== null ? $car->getModel_year():"" ;?>"  style="font-size:0.8em" class="form-control" id="email" placeholder="john.doe@email.com" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="text" name="name" style="font-size:0.8em" class="col-sm-6 col-form-label">
                                ...
                                <div class="col-sm-6">
                                <input type="text" name="evaluation" value= "<?php echo $car !== null ? $car->getEvaluation():"" ;?>"  style="font-size:0.8em" class="form-control" id="email" placeholder="john.doe@email.com" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="text" name="name" style="font-size:0.8em" class="col-sm-6 col-form-label">
                                ...
                                <div class="col-sm-6">
                                <input type="number" name="running" value= "<?php echo $car !== null ? $car->getRunning():"" ;?>"  style="font-size:0.8em" class="form-control" id="email" placeholder="john.doe@email.com" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="text" name="name" style="font-size:0.8em" class="col-sm-6 col-form-label">
                                ...
                                <div class="col-sm-6">
                                <input type="text" name="chassis" value= "<?php echo $car !== null ? $car->getChassis():"" ;?>"  style="font-size:0.8em" class="form-control" id="email" placeholder="john.doe@email.com" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="text" name="name" style="font-size:0.8em" class="col-sm-6 col-form-label">
                                ...
                                <div class="col-sm-6">
                                <input type="number" name="dimensions_L" value= "<?php echo $car !== null ? $car->getDimensions_L():"" ;?>"  style="font-size:0.8em" class="form-control" id="email" placeholder="john.doe@email.com" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="text" name="name" style="font-size:0.8em" class="col-sm-6 col-form-label">
                                ...
                                <div class="col-sm-6">
                                <input type="number" name="dimensions_W" value= "<?php echo $car !== null ? $car->getDimensions_W():"" ;?>" style="font-size:0.8em" class="form-control" id="email" placeholder="john.doe@email.com" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="text" name="name" style="font-size:0.8em" class="col-sm-6 col-form-label">
                                ...
                                <div class="col-sm-6">
                                <input type="number" name="dimensions_H" value= "<?php echo $car !== null ? $car->getDimensions_H():"" ;?>" style="font-size:0.8em" class="form-control" id="email" placeholder="john.doe@email.com" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="text" name="name" style="font-size:0.8em" class="col-sm-6 col-form-label">
                                ...
                                <div class="col-sm-6">
                                <input type="number" name="passengers" value= "<?php echo $car !== null ? $car->getPassengers():"" ;?>" style="font-size:0.8em" class="form-control" id="email" placeholder="john.doe@email.com" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="text" name="name" style="font-size:0.8em" class="col-sm-6 col-form-label">
                                ...
                                <div class="col-sm-6">
                                <input type="text" name="note" value= "<?php echo $car !== null ? $car->getNote():"" ;?>" style="font-size:0.8em" class="form-control" id="email" placeholder="john.doe@email.com" required>
                                </div>
                            </div>
                            <hr>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                <input onchange="myFunction()" type="number" value= "<?php echo $car !== null && $car->getPriceObject() !== null ? $car->getPriceObject()->getBuying():"" ;?>" name="buy" style="font-size:0.8em" class="form-control" id="buy" placeholder="john." >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="text" name="name" style="font-size:0.8em" class="col-sm-6 col-form-label">
                                ...
                                <div class="col-sm-6">
                                <input  onchange="myFunction()" type="number" value= "<?php echo $car !== null && $car->getAdditional() !== null ? $car->getAdditional()->getRtax():"" ;?>" name="rtax" style="font-size:0.8em" class="form-control" id="rtax" placeholder="john." >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="text" name="name" style="font-size:0.8em" class="col-sm-6 col-form-label">
                                ...
                                <div class="col-sm-6">
                                <input  onchange="myFunction()"  type="number" value= "<?php echo $car !== null && $car->getAdditional() !== null ? $car->getAdditional()->getAtax():"" ;?>"  name="auto_t" style="font-size:0.8em" class="form-control" id="auto_t" placeholder="john" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="text" name="name" style="font-size:0.8em" class="col-sm-6 col-form-label">
                                ...
                                <div class="col-sm-6">
                                <input  onchange="myFunction()"  type="number" value= "<?php echo $car !== null && $car->getAdditional() !== null ? $car->getAdditional()->getAu_cha():"" ;?>"  name="au" style="font-size:0.8em" class="form-control" id="au" placeholder="john.dom">
                                </div>
                            </div>
                            <hr>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                <input  onchange="myFunction()"  type="number" value= "<?php echo $car !== null && $car->getAdditional() !== null ? $car->getAdditional()->getTrasport():"" ;?>"  name="trans" style="font-size:0.8em" class="form-control" id="trans" placeholder="john." >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="text" name="name" style="font-size:0.8em" class="col-sm-6 col-form-label">
                                ...
                                <div class="col-sm-6">
                                <input  onchange="myFunction()"  type="number" value= "<?php echo $car !== null && $car->getAdditional() !== null ? $car->getAdditional()->getStorage():"" ;?>"  name="storage" style="font-size:0.8em" class="form-control" id="storage" placeholder="john" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="text" name="name" style="font-size:0.8em" class="col-sm-6 col-form-label">
                                ...
                                <div class="col-sm-6">
                                <input  onchange="myFunction()"  type="number" value= "<?php echo $car !== null && $car->getAdditional() !== null ? $car->getAdditional()->getInsurance():"" ;?>"  name="insu" style="font-size:0.8em" class="form-control" id="insu" placeholder="john.dom">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="text" name="name" style="font-size:0.8em" class="col-sm-6 col-form-label">
                                ...
                                <div class="col-sm-6">
                                <input  onchange="myFunction()"  type="number" name="repair" value= "<?php echo $car !== null && $car->getAdditional() !== null ? $car->getAdditional()->getRepair():"" ;?>"  style="font-size:0.8em" class="form-control" id="repair" placeholder="john.dom">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="text" name="name" style="font-size:0.8em" class="col-sm-6 col-form-label">
                                ...
                                <div class="col-sm-6">
                                <input  onchange="myFunction()"  type="number" name="other" value= "<?php echo $car !== null && $car->getAdditional() !== null ? $car->getAdditional()->getOther():"" ;?>"  style="font-size:0.8em" class="form-control" id="other" placeholder="john.dom">
                                </div>
                            </div>
                            <hr>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                <input type="number" name="sell" value= "<?php echo $car !== null && $car->getPriceObject() !== null ? $car->getPriceObject()->getSelling():"" ;?>" style="font-size:0.8em" class="form-control" id="sell" placeholder="john" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="text" name="name" style="font-size:0.8em" class="col-sm-6 col-form-label">
...
function myFunction() {
  ...
  Math.floor(repair.value)+Math.floor(other.value);
